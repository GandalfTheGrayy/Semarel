...
- `docs/FUTURE_SYSTEM_CONSTRAINTS.md` records broad architecture capability targets, not a roadmap, implementation order, schema, UI, mechanic, or balance specification.
